...
### Activation Methods <a href="#activation-methods" id="activation-methods"></a>

There are three primary methods to deploy preinstalled contracts on a Ontomir EVM chain:

#### 1. Genesis Configuration <a href="#id-1-genesis-configuration" id="id-1-genesis-configuration"></a>
...
#### 2. Governance Proposal <a href="#id-2-governance-proposal" id="id-2-governance-proposal"></a>
...
#### 3. Chain Upgrade Handler <a href="#id-3-chain-upgrade-handler" id="id-3-chain-upgrade-handler"></a>
...
#### Validation Process <a href="#validation-process" id="validation-process"></a>
...
#### Storage and State <a href="#storage-and-state" id="storage-and-state"></a>
...
#### Verify Deployment <a href="#verify-deployment" id="verify-deployment"></a>
...
### Adding Custom Preinstalls <a href="#adding-custom-preinstalls" id="adding-custom-preinstalls"></a>
...
#### Debugging Steps <a href="#debugging-steps" id="debugging-steps"></a>
