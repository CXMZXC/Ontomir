...
#### Architecture Deep Dive <a href="#architecture-deep-dive" id="architecture-deep-dive"></a>
...
#### Deposit/Withdraw Implementation Details <a href="#depositwithdraw-implementation-details" id="depositwithdraw-implementation-details"></a>
...
* **Result**: The precompile contract address has no balance; tokens stay with users This is why `deposit()` and `withdraw()` are no-ops - there's no separate wrapped token state to manage.
...
#### Standard ERC20 Interface <a href="#standard-erc20-interface" id="standard-erc20-interface"></a>
...
Transfers tokens using the bank module (identical to native Ontomir transfer).
...
#### `approve` / `allowance` / `transferFrom` <a href="#approve--allowance--transferfrom" id="approve--allowance--transferfrom"></a>
...
#### WETH Compatibility Methods <a href="#weth-compatibility-methods" id="weth-compatibility-methods"></a>
...
#### Cross-Interface Balance Verification <a href="#cross-interface-balance-verification" id="cross-interface-balance-verification"></a>
...
#### Working with IBC Tokens <a href="#working-with-ibc-tokens" id="working-with-ibc-tokens"></a>
...
### Solidity Interface & ABI <a href="#solidity-interface-andamp-abi" id="solidity-interface-andamp-abi"></a>
