...
> Ontomir EVM can dump the entire application state to a JSON file. This, besides upgrades, can be useful for manual analysis of the state at a given height.

### Export State[​](state-export-import.md#export-state) <a href="#export-state" id="export-state"></a>
...
### Manually Migrate State[​](state-export-import.md#manually-migrate-state) <a href="#manually-migrate-state" id="manually-migrate-state"></a>
